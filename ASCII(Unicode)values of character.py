...
print("The ASCII(unicode) value of character is:", str(ASCII_Value))  # we can also print it like that by using str()
#  function to concatenate string and integer value....The interpreter will take the output integer as string.
